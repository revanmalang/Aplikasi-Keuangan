...
class AdapterMoneyForHome :
    ListAdapter<TrxDataNotif, AdapterMoneyForHome.MoneyViewHolder>(diffCallback) {

    inner class MoneyViewHolder(val binding: ItemdatatrxHomeBinding) : RecyclerView.ViewHolder(binding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoneyViewHolder {
        return MoneyViewHolder(
            ItemdatatrxHomeBinding.inflate(
    ...
    override fun onBindViewHolder(holder: MoneyViewHolder, position: Int) {
        ...
        holder.binding.apply {
            holder.itemView.apply {
                ...
                holder.binding.dateHome.text = dates
